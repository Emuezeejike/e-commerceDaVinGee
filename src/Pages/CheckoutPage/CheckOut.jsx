...
const CheckOut = ({ cartItems = [] }) => {
  ...
  return (
    <div className="family-poppins bg-gray-100">
      ...
      <div className="flex flex-col md:flex-row justify-between m-auto p-4 md:p-8 w-full max-w-5xl min-h-screen bg-gray-100 gap-8">
        <form
          className="p-4 w-full md:w-1/2 bg-white shadow rounded mt-8"
        ...
        >
          ...
          <div className="flex flex-col gap-2">
            <label className="mt-4 text-sm" htmlFor="street">
              Street Address
            </label>
            <input
              className="border text-sm border-gray-400 p-2 rounded-sm"
          ...
          <div className="flex flex-col gap-2">
            <label className="mt-4 text-sm" htmlFor="town">
              Town/City
            </label>
            <input
              className="border text-sm border-gray-400 p-2 rounded-sm"
          ...
          <div className="flex flex-col gap-2">
            <label className="mt-4 text-sm" htmlFor="info">
          ...
          <div className="flex flex-col gap-2">
            <label className="mt-4 text-sm" htmlFor="payment">
              Payment Method
            </label>
            <select
              className="border text-sm border-gray-400 p-2 rounded-sm"
            ...
            <p className="text-xs">
              For Bank Transfer, Make your payment directly into our bank
        ...
        <div className="flex flex-col gap-2 w-full md:w-2/5 bg-white shadow rounded p-4 mt-8">
          <div>
