    ...
    <div className="bg-gray-200">
      <div className="bg-gray-200 w-[90%] flex justify-center items-center m-auto p-8 family-poppins">
        <div className="w-[50%] m-auto flex flex-col justify-center items-center p-4">
          <h2 className="text-black text-left font-croissant font-bold pt-3">
            Browse The Range
          </h2>
          <p className="text-black text-justify text-sm">
            Check out our exclusive shoe catalogue made from the finest of
            materials <br /> that gives your feet the comfort it needs to step
            into the world
          </p>
          <Link
            to={"/products"}
            className="bg-gray-300 text-black p-2 rounded-sm text-sm hover:bg-gray-500 mt-4"
          >
            Explore More
          </Link>
        </div>
        <Carousel
          className="w-[50%] m-auto family-poppins"
          showArrows={true}
          showStatus={false}
