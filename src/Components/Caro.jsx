...
const Caro = () => {
  return (
    <div className='bg-gray-100  flex justify-center items-center m-auto p-8 family-poppins'>
        <div className='w-[10%] flex justify-center items-center p-4'>
            <Carousel className='m-auto family-poppins'
                showArrows={true}
                showStatus={false}
              ...
              >
                <div className='flex w-[90%] m-auto justify-between items-center gap-8'>
                  <img className='rounded-4xl'  src={CaroImage2} alt="Slide 1" />
                  <div className='m-8'>
                    <p className='text-sm'>Maranini 1998</p>
                    <h2 className='text-3xl font-bold'>Moccasin</h2>
                ...
                <div className='flex w-[90%] m-auto justify-between items-center gap-4'>
                  <img className='rounded-4xl' src={CaroImage3} alt="Slide 1" />
                  <div>
                    <p className='text-sm'>British 1994</p>
                    <h2 className='text-3xl font-bold'>Brogue</h2>
                ...
                <div className='flex w-[90%] m-auto justify-between items-center gap-4'>
                  ...
                  <div>
                    ...
                    <h2 className='text-3xl font-bold'>Chelsea Boot</h2>
                ...
                <div className='flex w-[90%] m-auto justify-between items-center gap-4'>
                  ...
                  <div>
                    ...
                    <h2 className='text-3xl font-bold'>Straw Hat</h2>
