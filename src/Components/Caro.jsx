...
const Caro = () => {
  return (
    ...
    <h2 className="text-black text-center font-berkshire text-5xl font-bold m-8 pt-3">Always a Step Ahead</h2>
            ...
            <Carousel className='m-auto'
              ...
              >
                <div className='flex flex-col-reverse md:flex-row w-[90%] m-auto justify-between items-center gap-8'>
                  <img loading='lazy' className='rounded-4xl w-full md:w-auto'  src={CaroImage2} alt="Slide 1" />
                ...
                <div loading='lazy' className='flex flex-col-reverse md:flex-row w-[90%] m-auto justify-between items-center gap-8'>
                  <img className='rounded-4xl w-full md:w-auto' src={CaroImage3} alt="Slide 1" />
                  <div className='m-8 w-full md:w-auto'>
                ...
                <div loading='lazy' className='flex flex-col-reverse md:flex-row w-[90%] m-auto justify-between items-center gap-8'>
                  <img className='rounded-4xl w-full md:w-auto' src={CaroImage4} alt="Slide 1" />
                  <div className='m-8 w-full md:w-auto'>
                ...
                <div loading='lazy' className='flex flex-col-reverse md:flex-row w-[90%] m-auto justify-between items-center gap-8'>
                  <img className='rounded-4xl w-full md:w-auto' src={CaroImage5} alt="Slide 1" />
                  <div className='m-8 w-full md:w-auto'>
